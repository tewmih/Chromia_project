...
function TaskBax({ task, setEditModalOpen, setDeleteModalOpen }: taskprops) {
  ...
  return (
    <div className="group relative bg-white border border-gray-300 rounded-lg shadow-md p-4 w-64 hover:scale-105 hover:shadow-lg transition-transform duration-300 ease-in-out">
      {/* Task Title */}
      ...
      {/* Additional Actions */}
      <div className="absolute top-1 right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex gap-5">
        <FaRegEdit
          size={17}
          color="blue"
          cursor="pointer"
